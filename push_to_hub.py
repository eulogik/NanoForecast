...
def render_model_card(
    ...
    md.extend([
        ...
        "## Known limitations",
        "",
        "This checkpoint was trained on a single dataset (ETTh1, ~1000 windows, 20 epochs). "
        "It is **not** a production foundation model. Accuracy is limited (MASE 4-11 on ETT). "
        "What it does well: being deployable. Train your own for better accuracy.",
    ])
    return "\n".join(md) + "\n"
