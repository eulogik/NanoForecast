...
### Published
- **GitHub**: https://github.com/eulogik/NanoForecast — v0.1 committed and pushed
- **HF Model**: https://huggingface.co/eulogik/nanoforecast-200k — 676K params, Apache 2.0
...
### v0.2 Training (pending — on Mac Mini M4 16GB)
...
### Paper (after v0.2)
arXiv preprint: "NanoForecast: A Deployable Time Series Transformer Under 1M Parameters"
