...
\item \textbf{Model export}: ONNX export produces a 27.9\,MB FP32 model (9.2\,MB with INT8 quantization). Dynamic INT8 quantization overhead accounts for the latency increase vs.\ FP32.
...
\item Standard-protocol results: \texttt{results/standard\_benchmark.json} in the GitHub repository (protocol string included in the file)
